...
_For more information on the `E(zoe).startInstance` command please see the [Zoe API Documentation](https://docs.agoric.com/reference/zoe-api/zoe.html#e-zoe-startinstance-installation-issuerkeywordrecord-terms-privateargs)_
