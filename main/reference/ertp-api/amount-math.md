...
Verifies that an **Amount** is for the specified _brand_ and returns an equivalent **Amount**.
...
Returns the **Amount** representing an empty **Amount** for the _brand_ parameter's
...
Returns **true** if the **[AmountValue](./ertp-data-types#amountvalue)** of _leftAmount_ is greater than or equal to
...
Returns a new **Amount** that is the _leftAmount_ minus the _rightAmount_ (i.e.,
...
If _rightAmount_ is empty, this method returns _leftAmount_. If both arguments are
