...
- Price feeds are exposed on Agoric via the on-chain `home.priceAuthority`. This is an
  officially-sponsored [price authority](/conceptual/zoe/price-authority.md) built
...
[Low-level Oracle Query Contract](/conceptual/zoe/contracts/oracle.md) and submit a
query of the form:
