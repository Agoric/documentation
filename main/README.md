...
<div class="flex flex--column flex--center">
  <p>
    Learn about <a href="/ertp/guide/">ERTP</a>, a uniform way of transferring tokens and other digital assets in JavaScript.
  </p>
  <Button-Action-Link
...
<br>
<div class="flex flex--column flex--center">
  <p>Ready for more? Check out <a href="/zoe/guide/">Zoe</a>. Zoe is responsible for enforcing what we call "offer safety", and the smart contract that runs on top of Zoe is responsible for figuring out a proposed reallocation of resources.
  </p>
  <Button-Action-Link
    text="Build on Zoe"
    link="/zoe/guide/"
