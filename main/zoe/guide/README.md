...
::: tip Alpha status
The Agoric platform is at the alpha stage. It has not yet been formally tested
...
deep-freeze it with `@agoric/harden`. You can [learn more about `harden` here](https://agoric.com/documentation/distributed-programming.md#harden).)
