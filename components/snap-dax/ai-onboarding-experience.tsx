...
const onboardingSteps: Record<string, OnboardingStep> = {
  "cinematic-intro": {
    ...
    cinematicContent: {
      title: "SNAP-DAX",
      subtitle: "Supreme Financial Authority",
      description:
        "Enter the realm where Jon'Lorenzo Caprelli's vision of global economic transformation becomes reality",
      effects: ["particles", "hologram", "matrix", "quantum"],
    },
    nextStep: "welcome",
  },
        ...
        return (
          <div className="relative flex min-h-[600px] flex-col items-center justify-center overflow-hidden">
            ...
            >
              ...
              >
                {/* Outer royal glow */}
                <div className="absolute -inset-8 rounded-full bg-gradient-to-r from-amber-400/40 via-yellow-300/50 to-amber-400/40 blur-xl animate-pulse" />

                {/* Supreme Authority aura */}
                <div className="absolute -inset-6 rounded-full bg-gradient-to-r from-purple-500/30 via-cyan-400/30 to-amber-400/30 blur-lg" />

                {/* Coin container */}
                <div className="relative h-32 w-32 rounded-full overflow-hidden shadow-2xl border-4 border-amber-300/60">
                  <img
                    src="/jonlorenzo-caprelli-coin.jpeg"
                    alt="Jon'Lorenzo Caprelli Supreme Authority Coin"
                ...
                {/* Orbiting royal symbols */}
                <div className="absolute inset-0">
                  {[...Array(6)].map((_, i) => (
                    <motion.div
                      key={i}
                      className="absolute h-2 w-2 rounded-full bg-gradient-to-r from-amber-400 to-yellow-300"
                      initial={{
                        x: 64,
                        y: 64,
                        opacity: 0.8,
