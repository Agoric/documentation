...
export function ZillowApiStatus() {
  ...
  const checkApiStatus = async () => {
    ...
    try {
      ...
      // NEW: ensure we treat non-OK or subscription responses gracefully
      if (!response.ok || data.subscriptionRequired) {
        setStatus({
          source: data.subscriptionRequired ? "subscription" : "fallback",
